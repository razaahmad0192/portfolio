        ...
        <HeroWrapper>
          ...
          <motion.div className="console border md:w-[70%]  md:p-9 p-4  flex flex-col gap-3 rounded-2xl">
            ...
            <div className="pl-6 ">
              ...
              <p>
                <span className="text-purple-600">skills </span><span className="text-gray-500"> : </span><span className="text-orange-500">[</span><span className="text-green-600"> 'React'</span><span className="text-gray-500">, </span><span className="text-green-600"> 'Next.js'</span><span className="text-gray-500">, </span><span className="text-green-600"> 'Express.js'</span><span className="text-gray-500">, </span><span className="text-green-600"> ' MongoDb ' </span><span className="text-orange-500"> ] </span><span className="text-gray-500"> , </span>
              </p>
              <p>
