...
const Banner = () => {
  return (
    ...
    min-h-[calc(100vh-64px)]   ">
      <div className="flex flex-wrap w-full">
        <div className="w-full  flex flex-col items-center md:items-start  justify-center ">
          ...
          <div className='btnss mt-3 flex items-center justify-center flex-wrap md:gap-7 gap-2.5'>
            ...
            <button className='px-3 py-2 bg-black rounded-lg border-gray-100 border  text-white hover:bg-blue-600 font-semibol '><Link
      ...
      <motion.div className="console border md:w-[60%]  p-9 flex flex-col gap-3 rounded-2xl">
